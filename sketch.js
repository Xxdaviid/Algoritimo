...
function draw() {
  ...
  if( mousevivo.x - mouse.x < mouse.width/2 + mousevivo.width/2                                                                                   
    &&mouse.x - mousevivo.x < mouse.width/2 + mousevivo.width/2  
    &&mousevivo.y - mouse.y < mouse.height/2 + mousevivo.height/2                                                                                   
    &&mouse.y - mousevivo.y < mouse.height/2 + mousevivo.height/2  ){
